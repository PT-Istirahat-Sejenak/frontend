...
class SeekerLoginScreen extends StatelessWidget {
  SeekerLoginScreen({super.key});
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  onTap: () {
                    Navigator.pushNamed(context, AppRoutes.seekerForgetPassword);
                    },
                  ),
                ],
              ),
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () => Navigator.pushNamed(context, AppRoutes.seekerRegister),
                    child: const Text(
                      "Daftar",
                      style: TextStyle(
                        color: Color(0xFFAA0000),
